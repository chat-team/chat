 ...
 */
@WebServlet(name = "QueryFriend", urlPatterns = {"/queryfriend"})
public class QueryFriend extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String sql = "select user_info.userid, user_info.nickname from\n" +
                "user_info,\n" +
                "((select userbid as userid from friend where useraid=?/* and state=true */)\n" +
                "union DISTINCT\n" +
                "(select useraid as userid from friend where userbid=?/* and state=true */)) as t\n" +
                "where user_info.userid = t.userid;";
